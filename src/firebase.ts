...
// Support both JSON config (for AI Studio) and Environment Variables (for Vercel/Production)
const firebaseConfig = {
  ...
  firestoreDatabaseId: import.meta.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID || firebaseConfigFromJson.firestoreDatabaseId || '(default)'
};
